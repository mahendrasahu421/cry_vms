    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            <div class="page-header">
                <div>
                    <h1 class="page-title">
                        Volunteer Assign Task</h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="admin-dashboard">Home</a></li>
                        <li class="breadcrumb-item active text-warning" aria-current="page"> Volunteer Assign Task</li>
                    </ol>
                </div>
            </div>
            <div class="row row-sm">
                <div class="col-lg-12">
                    <div class="card">
                        <form action="volunteer-assign-task" method="post">
                        ...
                        <form action="volunteer_assign_taskDetails_exportToExcel">
                            ...
                            <div class="table-responsive">
                                <table id="example" class="display nowrap" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php
                                        $count = 1;
                                        foreach ($volunteerDetails as $volunteerData) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $volunteerData['assigned_date']; ?>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <button type='button'
                                                    class='badge bg-warning  me-1 mb-1 mt-1'>Assigned</button>
                                                <?php } else { ?>
