												...
												<tr>
													...
													<td>
														<?php if ($volunteerData['status'] == 2) { ?>
															<button type='button' onclick="getId_sendmail('<?php echo $volunteerEmail; ?>',<?php echo $relocateState; ?>,<?php echo $volunteer_city; ?>,<?php echo $relocate_id; ?>,<?php echo $volunteer_id; ?>)" class='badge bg-warning  me-1 mb-1 mt-1'>Accepted</button>
														<?php } else { ?>
															<button type='button' onclick="getId_sendmail('<?php echo $volunteerEmail; ?>',<?php echo $relocateState; ?>,<?php echo $volunteer_city; ?>,<?php echo $relocate_id; ?>,<?php echo $volunteer_id; ?>)" class='badge bg-info  me-1 mb-1 mt-1'>Accept</button>
