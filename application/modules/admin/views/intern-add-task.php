                    ...
                    <form action="<?php echo base_url(); ?>interninsert_add_task" method="post" id="form" name="pForm"
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <label for="validationCustom02" class="form-label">Select Region<sup
                                            class="text-danger fs-6">*</sup></label>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="ininvalid-feedback">Select Start Date</div>
                                </div>
                                <div class="col-md-4 ">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control"
                                        ...
                                        name="intern_required" value="" required />
                                ...
                                <div class="col-md-4">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea2" rows="2"
                                        placeholder="Title" maxlength="150" name="title" required></textarea>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="">
                                        <textarea class="content" name="what_to_do" rows="4" cols="10"
                                            required></textarea>
                                    </div>
