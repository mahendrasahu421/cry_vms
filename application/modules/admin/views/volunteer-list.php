							...
							<div class="card-header">
								<div class="col-md-4">
									...
									<select class="form-control select2-show-search form-select" name="programName" id="programName" required>
										...
										?>
											<option value="<?php echo $volunteer_programsData['program_id']; ?>"><?php echo $program['program_id'] == $volunteer_programsData['program_id'] ? 'selected' : ''; ?><?php echo $volunteer_programsData['program_name'] ?></option>
										<?php } ?>
									</select>
								</div>
								<div class="col-md-4">
									...
									<select class="form-control select2-show-search form-select" name="certificate" id="certificate">
										...
										?>
											<option value="<?php echo $cretificate['certificate_id']; ?>"><?php echo $cretificate['certificate_type'] ?></option>
										<?php } ?>
									</select>
								</div>
						...
						<form method="post" action="updatePresent_volunteer" id="id-form">
							...
							<div class="card-body">
								<div class="table-responsive ">
									...
									<table id="example" class="display" cellspacing="0" width="100%">
										...
										<tbody id="totalProgramvolunteer">
											...
											?>
												<tr>
													<td>
														<input class="che" id="volunteer_id" name="ProgramVolunteer_id[]" value="<?php echo $ProgramVolunteer_id; ?>" type="checkbox">
													</td>
													<td>
													...
													<td>
														<?php if ($volunteerData['certificate_id'] == 0) { ?>
															<button type='button' class='badge bg-warning  me-1 mb-1 mt-1'>Not Maped</button>
														<?php } else { ?>
															<button type='button' class='badge bg-info  me-1 mb-1 mt-1'> Maped</button>
									...
									<input type="submit" id="submit3" value="Map Certificate " class="mt-5 btn btn-warning  pull-right" id="map_button" style="padding: 1% 2% 1% 2%;">
