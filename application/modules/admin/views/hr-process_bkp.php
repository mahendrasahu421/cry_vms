                    ...
                    <div class="">
                                        ...
                                        <div class="process">
                                            <div class="process-row nav nav-tabs">
                                                ...
                                                <div class="process-step" style="width: 20%;">
                                                    ...
                                                    <br>
                                                    <button class="btn btn-info interview_final_mail" title="Email"><i class="fa fa-paper-plane" aria-hidden="true"></i></button>
                                                ...
                                                <div class="process-step" style="width: 20%;">
                                                    ...
                                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#updateOfferlatter">
                                                        Create New
                                                    </button>
                                                    <!-- <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#mymodel2">
                                                        Preview And Send Offer
                                                    </button> -->
                                                </div>
                                                <div class="modal fade" id="updateOfferlatter" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="col-md-12">
                                                                            <label class="form-label"> Joining
                                                                                Date</label>
                                                                            <input type="date" class="form-control" value="<?php echo $interuser['creation_date']; ?>" id="offerLatter_update_date" name="offerLatter_update_date" />
                                                                        </div>
                            ...
                            <div id="myModal" class="modal fade" role="dialog" data-backdrop="static">
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <div class="text-center confirm" id="confirm_short"><button type="button" class="btn btn-primary fs-14" data-bs-dismiss="modal">Yes</button>
                                            </div>
                                            <div class="text-center cancel_short"><button type="button" class="btn btn-default fs-14" data-bs-dismiss="modal">NO</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="myModal1" class="modal fade" role="dialog" data-backdrop="static">
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <div class="text-center confirm" id="confirm_reject"><button type="button" class="btn btn-primary fs-14" data-bs-dismiss="modal">Yes</button>
                                            </div>
                                            <div class="text-center cancel_short"><button type="button" class="btn btn-default fs-14" data-bs-dismiss="modal">NO</button>
                                            </div>
                                        </div>
                        ...
                        <script type="text/javascript">
                            ...
                            $(document).on("click", ".save_schedule", function() {
                                ...
                                var previous_date_value = $(this).parents("tr").prev("tr").find(".schedule_date")
                                    .val();
                                if (mode == '') {
                                    mode_id.focus();
                            ...
                            $(document).on("change", ".interview_status", function() {
                                ...
                                switch ($(this).val()) {
                                    case '':
                                        disable_round_details(mode_object, schedule_date_object,
                            ...
                            $(document).on("click", ".mail_btn_action", function(event) {
                                var parentid = $(this).parents("tr");
                                if (parentid.find(".interview_status").val() != 1 && parentid.find(
                                        ".interview_status")
                                    .val() != 3) {
                                    var mode_id = parentid.find(".mode");
