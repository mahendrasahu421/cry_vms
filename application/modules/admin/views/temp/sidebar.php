    ...
    <aside class="app-sidebar">
        <div class="side-header">
            <a class="header-brand1" href="<?php echo base_url('admin-dashboard')?>">
                <img src="<?php echo base_url('admin/'); ?>assets\images\brand\cry-yellowlogo.gif"
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <a class="side-menu__item" data-bs-toggle="slide"
                        href="<?php echo ($menu_detail[0]['menu_route_name'] == "#" ? "#" : base_url() . $menu_detail[0]['menu_route_name']); ?>"><i
                            class="side-menu__icon fe fe-database"></i><span
                            class="side-menu__label"><?php echo $menu_detail[0]['menu_description']; ?></span><i
                    ...
                    <ul class="slide-menu">
                        ...
                        <li>
                            <a href="<?php echo ($sub_menu_detail[0]['sub_menu_route'] == "#"  ? "#" : base_url() . $sub_menu_detail[0]['sub_menu_route']); ?>"
                                class="slide-item">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);"><i
                            class="side-menu__icon fe fe-package"></i><span class="side-menu__label">Program
                            Volunteer</span><i class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);"><i
                            class="side-menu__icon fe fe-package"></i><span class="side-menu__label">Transfer
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);"><i
                            class="side-menu__icon fe fe-package"></i><span class="side-menu__label">Volunteer Section
                    ...
                    <ul class="slide-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url(); ?>volunteer-task-report" class="slide-item">
                                Task Report
                            </a>
                        </li>
                        <li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);"><i
                            class="side-menu__icon fe fe-package"></i><span class="side-menu__label">Intern Section
                            Report</span><i class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url(); ?>shortlisted-intern" class="slide-item">
                               Shortlisted interns
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="<?php echo base_url(); ?>sent-certificate" class="slide-item">
                                Send Certificate Report
                            </a>
                        </li>
                        <!-- <li>
