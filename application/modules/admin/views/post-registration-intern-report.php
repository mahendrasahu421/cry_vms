    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <div>
                    <h1 class="page-title">Post Registration Intern Report</h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Post Registration Intern Report</li>
                    </ol>
                </div>
                                ...
                                <table id="example" class="display nowrap" style="width:100%">
                                    <thead>
                                        <tr class="bg-gray-light">
                                            ...
                                            <th>Upload a close up photo</th>
                                            <th>CV</th>
                                            <th>Reference Letter</th>
                                            <th>Start date of internship</th>
                                            <th>Profile of project you will be involved in</th>
                                            <th>No of weeks of internship</th>
                                            <th>Status</th>
                                        </tr>
                                    </thead>
                                    <tbody>
