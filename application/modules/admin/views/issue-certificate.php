					...
					<form action="" method="post" id="sendCertificate">
							<div class="card-header">
								<div class="col-md-4">
									...
									<select class="form-control select2-show-search form-select" name="programName" id="programName">
										<option value="">Select Program Name</option>
										<?php foreach ($volunteer_programs as $volunteer_programsData) {
										?>
											<option value="<?php echo $volunteer_programsData['program_id']; ?>"<?php echo $program == $volunteer_programsData['program_id'] ? 'selected' : ''; ?>><?php echo $volunteer_programsData['program_name'] ?></option>
										<?php } ?>
									</select>
								</div>
								<div class="col-md-4">
									<select class="form-control select2-show-search form-select" name="certificate" id="certificate">
										<option value="">Select Certificate</option>
										<?php foreach ($certificateFormat as $cretificate) {
										?>
											<option value="<?php echo $cretificate['certificate_id']; ?>"<?php echo $certificateId == $cretificate['certificate_id'] ? 'selected' : ''; ?>><?php echo $cretificate['certificate_type'] ?></option>
										<?php } ?>
									</select>
								</div>
									...
									<table id="example" class="display" cellspacing="0" width="100%">
										...
										<tbody>
											...
											?>
												<tr>
													<td>
														<input class="che" id="volunteer_id" name="ProgramVolunteeremailid[]" value="<?php echo $ProgramVolunteer_id; ?>" type="checkbox">
													</td>
													<td>
													...
													<td>
														<?php if ($volunteerData['status'] == 3) { ?>
															<button type='button' onclick="getId_sendmail('<?php echo $ProgramVolunteer_id; ?>')" class='badge bg-warning  me-1 mb-1 mt-1'>Cretificate Send Successfully</button>
														<?php } else { ?>
															<button type='button' onclick="getId_sendmail('<?php echo $ProgramVolunteer_id; ?>')" class='badge bg-info  me-1 mb-1 mt-1'>Send Cretificate</button>
