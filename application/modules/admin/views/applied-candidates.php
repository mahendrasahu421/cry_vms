                    ...
                    <div class="card">
                        <form action="applied-candidates" method="post" id="form">
                            <div class="card-header">
                                ...
                                <div class="col-md-2">
                                    <select class="form-control select2-show-search form-select" name="candidate_staus"
                                        id="candidate_staus">
                                        ...
                                        <option value="7">Post Registraion Completed</option>
                                        <option value="8">Candidate Onboarded</option>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo base_url(); ?>hr-process/<?php echo $encoded_id; ?>"
                                                    class="badge rounded-pill bg-info me-1 mb-1 mt-1">
