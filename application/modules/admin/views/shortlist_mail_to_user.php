                          ...
                          <tr>
                            <td valign="middle" width="100%" style="text-align:left; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: #515151; line-height: 24px;" t-style="textColor" class="fullCenter" mc:edit="4" object="text-editable">
                              ...
                              <span style="font-family: 'proxima_nova_rgregular', Helvetica; font-weight: normal; ">
                                <!--<![endif]-->
                                <singleline>
                                 We are happy to inform you that you have been added to the list of shortlisted.
                          ...
                          <tr>
                            <td valign="middle" width="100%" style="text-align: left; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: #515151; line-height: 24px;" t-style="textColor" class="fullCenter" mc:edit="4" object="text-editable">
                              ...
                              <span style="font-family: 'proxima_nova_rgregular', Helvetica; font-weight: normal;">
                                <!--<![endif]-->
                                <singleline>
                                  Our team will make sure to update you with any changes to your status as soon as possible.
                                </singleline>
                                <!--[if !mso]><!-->
                              </span>
                              <!--<![endif]-->
                          ...
                          <tr>
                            <td valign="middle" width="100%" style="text-align: left; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: #515151; line-height: 24px;" t-style="textColor" class="fullCenter" mc:edit="4" object="text-editable">
                              ...
                              <span style="font-family: 'proxima_nova_rgregular', Helvetica; font-weight: normal;">
                                <!--<![endif]-->
                                <singleline>
                                  We wish you the best of luck with your application process.
                                </singleline>
                                <!--[if !mso]><!-->
                              </span>
                              <!--<![endif]-->
...
<br />Support : +91-9889-062374
                  ...
                  <span style="font-family: 'proxima_nova_rgregular', Helvetica;">
                    <!--<![endif]-->
                    <!--subscribe--><a href="#" style="text-decoration: none; color: #959595;" t-style="copyright" object="link-editable"></a><!--unsub-->
                    <!--[if !mso]><!-->
                  </span>
                  <!--<![endif]-->
                </td>
                  ...
                  <table width="300px" style="text-align:center;margin-left: 100px;">
                    <tr>
                      <td style="padding:3px 0 0 6px;  font-family: 'proxima_nova_rgregular', Helvetica;font-weight: normal;font-size: 11px;" colspan="2">
                       Copyright © 2017 <span class="aBn" data-term="goog_2007155060" tabindex="0"><span class="aQJ">cryvms</span></span>							
                      </td>
                    </tr>
                    <tr>
                      <td width="100%" height="20px" style="font-size: 1px; line-height: 14px;">
