...
<body style="background-color: #e9ecef;">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td align="center" valign="top" style="padding: 36px 24px;">
                            <a href="https://sendgrid.com" target="_blank" style="display: inline-block;">
                                <!-- <img src="ezgif.com-gif-maker.gif" alt="Logo" border="0" width="48"
        ...
        <![endif]-->
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td align="right" bgcolor="#f7b731 "
                            style="padding: 36px 24px 0; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; border-top: 3px solid #d4dadf;">
                            <a href="https://sendgrid.com" target="_blank" style="display: inline-block;">
                                <img src="cry_logo.gif" alt="Logo" border="0" width="48"
                                    style="display: block; width: 48px; max-width: 48px; min-width: 48px;">
                            </a>
                        </td>
                        <td align="right" bgcolor="#f7b731 "
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;">Welcome To CRY Please Fill The the Form Which Is given below link And
                                join with CRY
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center" bgcolor="#f7b731 "
                            style="padding: 36px 24px 0; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; border-top: 3px solid #d4dadf;">
                            <style>
                                ul#menu li {
                                    display: inline;
                            ...
                            <Ul id="menu">
                                <li><i class='fab fa-facebook' style='font-size:24px'></i></li>
                                <li><i class='fab fa-instagram' style='font-size:24px'></i></li>
                                <li><i class='fab fa-whatsapp' style='font-size:24px'></i></li>
                                <li><i class='fab fa-youtube' style='font-size:24px'></i></li>
