								...
								<div class="form-row">
									...
									<!-- <div class="form-group col-md-6 mb-0">
										...
										<div class="input-group mb-4">
											<?php if($volunteerDetails[0]['date_of_birth']=="0000-00-00"){
												$dob="";
											 }else{
												$dob= date('d/m/Y',strtotime($volunteerDetails[0]['date_of_birth']));
											 }?>
									...
									<!-- <div class="form-group col-md-6 mb-0 select-dropdown">
										...
										<select class="form-control" data-placeholder="" name="gender">
											<option <?php if($volunteerDetails[0]['gender']==1){echo 'selected=selected';}?> value="1" <?php echo $volunteerDetails[0]['gender']; ?>>Male</option>
											<option <?php if($volunteerDetails[0]['gender']==2){echo 'selected=selected';}?> value="2" <?php echo $volunteerDetails[0]['gender']; ?>>Female</option>
											<option <?php if($volunteerDetails[0]['gender']==3){echo 'selected=selected';}?> value="3" <?php echo $volunteerDetails[0]['gender']; ?>>Transgender</option>
										</select>
									</div> -->
									<!-- <div class="form-group col-md-6 mb-0">
										<label class="form-label fw-bold"> Enter Email</label>
										<input type="email" class="form-control" placeholder="Email" value="<?php echo $volunteerDetails[0]['email']; ?>" required name="email">
									</div> -->
									<div class="form-group col-md-6 mb-0">
									...
									<div class="form-group col-md-6 mb-0">
										...
										<input type="text" class="form-control" placeholder="" value="<?php echo $volunteerDetails[0]['emergency_contact']; ?>" required name="emergency_contact">
									</div>
<!-- 
									<div class="form-group col-md-6 mb-0 select-dropdown">
										...
										<select class="form-control select2" name="city_id">
											...
											<option <?php if($volunteerDetails[0]['city_id']==$cc['city_id']){echo 'selected=selected';}?> value="<?php $cc['city_id']; ?>"><?php echo $cc['city_name']; ?></option>
											<?php } ?>
										</select>
									</div> -->
									<!--<div class="form-group col-md-6 mb-0 select-dropdown">
										...
										<select class="form-control select2" name="occupation_id">
											...
											<option <?php if($volunteerDetails[0]['occupation_id']==$occ['occupation_id']){echo 'selected=selected';}?> value="<?php $occ['occupation_id']; ?>"><?php echo $occ['occupation_name']; ?></option>
											<?php } ?>
										</select>
									</div>-->
									...
									<!-- <div class="form-group col-md-6 mb-0 select-dropdown">
										...
										<select class="form-control select2" name="vol_type_id">
											...
											<option <?php if($volunteerDetails[0]['vol_type_id']==$vt['vol_type_id']){echo 'selected=selected';}?> value="<?php echo $vt['vol_type_id']; ?>"><?php echo $vt['vol_type_name']; ?></option>
											<?php } ?>
										</select>
									</div> -->
									<!-- <div class="form-group col-md-12 mb-0 select-dropdown">
										...
										<select class="form-control select2"  multiple name="opportunity_id[]">
											...
											<option <?php if($volunteerDetails[0]['opportunity_id']==$opr['opportunity_id']){echo 'selected=selected';}?> value="<?php $opr['opportunity_id']; ?>"><?php echo $opr['opportunity_name']; ?></option>
											<?php } ?>
										</select>
									</div>
								</div> -->
