    ...
    <aside class="app-sidebar">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="intern-dashbord">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="<?php echo base_url(); ?>intern-add-daily-report" class="slide-item"> Add Daily Report</a></li>
                        <li><a href="<?php echo base_url(); ?>intern-daily-report" class="slide-item"> View Daily Report</a></li>  
