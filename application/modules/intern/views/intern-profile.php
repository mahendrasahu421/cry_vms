					...
					<div class="card">
						...
						<div class="card-body">
							<div class="row">
								...
								<div class="col-md-8">
									<h2 class="f-24 font-medium"><?php echo $internDetails[0]['first_name'].' '.$internDetails[0]['last_name']; ?></h2>
									...
									<div class="row mb-2">
										...
										<div class="col"><span class="text-inverse"><span class="__cf_email__" data-cfemail="<?php echo $internDetails[0]['email']; ?>"><?php echo $internDetails[0]['email']; ?></span></span></div>
									</div>
									<div class="row mb-2">
