                                            ...
                                            <div class="card">
                                                <form id="documentdetails" name="pForm" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="control-group form-group col-md-6 mb-0">
                                                            <label class="form-label fw-bold">ID proof <span style="color:red; font-size:20px;">*</span>
                                                                <input type="file" class="form-control" id="id_proof_attach1" name="id_proof_attach1" class="form-control" required accept=".pdf" value="">
                                                        ...
                                                        <div class="control-group form-group col-md-6 mb-0">
                                                            ...
                                                            <input type="file" class="form-control" id="add_proof_attach" name="add_proof" accept=".pdf" class="form-control" required value="">
                                                    ...
                                                    <div class="control-group form-group col-md-6 mb-0">
                                                        ...
                                                        <input type="file" class="form-control" accept=".jpg" id="close_up_photo" name="close_up_photo" class="form-control" required value="">
                                        ...
                                        <section style="display:none;" id="section3">
                                            <div class="card">
                                                <form method="post" action="" id="occupationDetails" name="pForm" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row">
                                                        <div class="control-group form-group col-md-6 mb-0">
                                                            <label class="form-label fw-bold">Name of your school/college/university/company/institution you are currently engaged?(write NA if not applicable) <span style="color:red; font-size:20px;">*</span></label>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="control-group form-group col-md-6 mb-0">
                                                            <label class="form-label fw-bold">Which CRY office you had
                                                                communicated with/ written to? <span style="color:red; font-size:20px;">*</span>
                                                            </label>
                                                    ...
                                                    <h5><strong>Read the below 3 Documents Properly <span style="color:red; font-size:20px;">*</span></strong></h5>
                                                    <div class="row">
