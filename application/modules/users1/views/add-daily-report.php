...
<div class="col-md-6">
	...
	foreach ($attachment_type as $key => $value) {
				...
				$limit = '';
				$order_by = array('attachmentID','DESC');
				$attachment = $this->Curl_model->fetch_data_in_many_array('attachment',$fields,$where,$limit,$order_by);
				//print_r($attachment);
		?>
		<div class="form-group row">
				<label for="inputEmail3" class="col-sm-3 col-form-label">Add <?php echo $value['attachmentTypeName']; ?></label>
				<div class="col-sm-7">
					<input type="file" class="form-control img" onchange="check_size(this,this.value,'idid');" name="<?php echo $value['attachmentTypeName']; ?>[]" id="#img<?php echo $value['attachmentTypeID']; ?>" accept="<?php echo $value['attachmentFileType']; ?>" />
					
					<label for="#"><?php if(sizeof($attachment)>0){echo $attachment[0]['attachmentName'];} ?></label>
					<input type="text" class="" style="display:none;" name="temp<?php echo $value['attachmentTypeName']; ?>[]" value="<?php if(sizeof($attachment)>0){echo $attachment[0]['attachmentName']; }?>" id="#img<?php echo $value['attachmentTypeID']; ?>" />
					<input type="text" class="" style="display:none;" name="size<?php echo $value['attachmentTypeName']; ?>[]" value="<?php if(sizeof($attachment)>0){echo $attachment[0]['attachmentSize']; }?>" id="#img<?php echo $value['attachmentTypeID']; ?>" />
					<input type="number" class="" name="id<?php echo $value['attachmentTypeName']; ?>[]" value="<?php if(sizeof($attachment)>0){echo $attachment[0]['attachmentID']; }?>" style="display:none;" id="#img<?php echo $value['attachmentTypeID']; ?>" />
				</div>
				<div class="col-sm-2">
			...
			<input type="number" id="count<?php echo $value['attachmentTypeID']; ?>" value="<?php if(sizeof($attachment)>0){ echo sizeof($attachment); }else{ echo 1;} ?>" style="display: none;">
			...
			<ul id="list<?php echo $value['attachmentTypeID']; ?>">
				<?php 
				foreach ($attachment as $key2 => $value2) {
					if($key2!=0)
					{

				?>
				<li class="" style="">
				<label for="#"><?php echo $value2['attachmentName']; ?></label>
				<br>
				<input type="text" class="img-add" style="display:none;" name="temp<?php echo $value['attachmentTypeName']; ?>[]" value="<?php echo $value2['attachmentName']; ?>">
				<input type="number" class="img-add" name="id<?php echo $value['attachmentTypeName']; ?>[]" value="<?php echo $value2['attachmentID']; ?>" style="display:none;">
				<input type="number" class="img-add" name="size<?php echo $value['attachmentTypeName']; ?>[]" value="<?php echo $value2['attachmentSize']; ?>" style="display:none;">
				<input type="file" class="img-add" onchange="check_size(this,this.value,'idid');" name="<?php echo $value['attachmentTypeName']; ?>[]" accept=".jpg,.jpeg,.png,.gif"><span class="add-file" onclick="closeMe(this,'#count1');"><i class="fa fa-trash"></i></span>
				</li>
				<?php }} ?>
				<li class="default<?php echo $value['attachmentTypeID']; ?>" style="display: none;">
				<input type="text" class="img-add" style="display:none;" name="temp<?php echo $value['attachmentTypeName']; ?>[]">
				<input type="number" class="img-add" name="id<?php echo $value['attachmentTypeName']; ?>[]" style="display:none;">
				<input type="number" class="img-add" name="size<?php echo $value['attachmentTypeName']; ?>[]" style="display:none;">
				<input type="file" class="img-add" onchange="check_size(this,this.value,'idid');" name="<?php echo $value['attachmentTypeName']; ?>[]" accept="<?php echo $value['attachmentFileType']; ?>" /><span class="add-file" onclick="closeMe(this,'#count<?php echo $value['attachmentTypeID']; ?>');"><i class="fa fa-trash"></i></span>
				</li>
			</ul>
