...
<h6 class="text-muted m-b-0"><?php echo "$ttime11";?> / 250 Hours</h6>
</div>
</div>
</div>
</div>
...
<h6 class="text-muted m-b-0"><?php echo "$ttime11";?> / 500 Hours</h6>
</div>
</div>
</div>
</div>
...
<div class="d-flex pt-3 pb-2 no-block">
<div class="align-self-center mr-2 knob-icon knob-icon-2">
<input class="dial" data-plugin="knob" data-width="40" data-height="40" data-linecap="round" data-fgColor="#f95476" data-thickness=".2" value="89" />
<i class="fa fa-repeat f-24 text-danger"></i> </div>
<div class="align-slef-center mr-auto">
<h2 class="m-b-0 text-uppercase f-18 font-medium lp-5">PLATINUM BADGE</h2>
<h6 class="text-muted m-b-0"><?php echo "$ttime11";?> / 4000 Hours</h6>
</div>
</div>
</div>
</div>
...
<h6 class="text-muted m-b-0 text-center mt-2"><i class="fa fa-clock"></i> <?php echo "$tottime";?></h6>
</div>
</div>
</div>
</div>
