...
<form action="#" method="post" name="form" id="form">
		...
		<div class="form-group row">
			...
			<div class="col-sm-8">
				<input type="text" id="dob_caf" name="birthday1" placeholder="Date Of Birth" <?php if($userDetails[0]['dateOfBirth']!='0000-00-00'){ echo 'value="'.ucwords(date("d-m-Y", strtotime($userDetails[0]['dateOfBirth']))).'"';} ?> class="form-control birthday" />
			</div>
		</div>
		<div class="form-group row">
			<label for="progress-t-pwd" class="col-sm-3 col-form-label">Mobile no.</label>
			<div class="col-sm-8">
				<input type="text" class="form-control" id="progress-t-pwd2" name="mobile" readonly placeholder="<?php echo ucwords($userDetails[0]['mobile']); ?>" value="<?php echo ucwords($userDetails[0]['mobile']); ?>">
			</div>
		</div>
...
<div class="tab-pane" id="progress-t-tab2" ng-controller="ExampleController">
		...
		<p><button class="btn btn-warning">References-1</button></p>
		...
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control ref1_contact" id="progress-t-email" name="ref1_contact" placeholder="<?php echo $userDetails[0]['ref1_contact']; ?>" value="<?php echo ucwords($userDetails[0]['ref1_contact']); ?>">
			</div>
		...
		<p><button class="btn btn-warning">References-2</button></p>
		...
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control ref2_contact" id="ref2_contact" name="ref2_contact" placeholder="<?php echo $userDetails[0]['ref2_contact']; ?>" value="<?php echo ucwords($userDetails[0]['ref2_contact']); ?>" />
			</div>
...
<div class="tab-pane" id="progress-t-tab3">
	...
	<input type="checkbox" class="custom-control-input" id="customCheck1" name="policy_status" required checked />
	...
	<div class="row justify-content-between btn-page">
		...
		<button type="button" onclick="red('https://www.caritasindia.org/vms/profile');"class="btn btn-warning button-next" style="display:none;" id="done_next">Done</button>
		</div>
	</div>
</form>
</div>
