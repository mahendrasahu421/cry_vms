...
$route['post-registration-intern'] = 'login/Login/post_registration_intern';
...
$route['Certificate'] = 'users/User/Certificate';
...
$route['view-task'] = 'admin/Admin/view_task';
$route['view-task/(:any)'] = 'admin/Admin/view_task';
$route['edit-task'] = 'admin/Admin/edit_task';
$route['edit-task/(:any)'] = 'admin/Admin/edit_task';
...
$route['volenteership'] = 'admin/Admin/volenteership';
$route['volenteership/(:any)'] = 'admin/Admin/volenteership';
...
$route['add-task'] = 'admin/Admin/add_task';
$route['update_task'] = 'admin/Admin/update_task';
$route['intern_update_task'] = 'admin/Admin/update_task';
$route['insert_add_task'] = 'admin/Admin/insert_add_task';
$route['interninsert_add_task'] = 'admin/Admin/interninsert_add_task';
$route['add-task/(:any)'] = 'admin/Admin/intern_add_task';
// $route['internedit-task/(:any)'] = 'admin/Admin/internedit_task';
$route['task-list'] = 'admin/Admin/task_list';
$route['task-list/(:any)'] = 'admin/Admin/task_list';
$route['intern-task-list'] = 'admin/Admin/intern_task_list';
$route['assigned-task'] = 'admin/Admin/assigned_task';
$route['assigned-task/(:any)'] = 'admin/Admin/assigned_task';
...
$route['view-assigned-task'] = 'admin/Admin/view_assigned_task';
...
$route['tast-report'] = 'admin/Admin/tast_report';
...
$route['intern-request-certificate'] = 'admin/Admin/intern_request_certificate';
$route['intern-request-certificate/(:any)'] = 'admin/Admin/intern_request_certificate';
...
$route['enquiry'] = 'admin/Admin/enquiry';
...
$route['ragistration-volunteer'] = 'admin/Admin/ragistration_volunteer';
...
$route['program-volunteer-list'] = 'admin/Admin/program_volunteer_list';
$route['add-program-volunteer'] = 'admin/Admin/add_program_volunteer';
$route['edit-program-volunteer/(:any)'] = 'admin/Admin/edit_program_volunteer';
$route['insert-program'] = 'admin/Admin/insert_program';
$route['update-program'] = 'admin/Admin/update_program';
$route['volunteer-list'] = 'admin/Admin/volunteer_list';
$route['program-volunteer'] = 'admin/Admin/program_volunteer';
$route['issue-certificate'] = 'admin/Admin/issue_certificate';
$route['share-link'] = 'admin/Admin/share_link';
...
//$route['edit-country/(:any)'] = 'admin/Admin/edit_country';
...
$route['shortlist_status_update'] = 'admin/Admin/shortlist_status_update';
$route['get_same_day_schedule_user_count'] = 'admin/Admin/get_same_day_schedule_user_count';
$route['save_interview_schedule_data'] = 'admin/Admin/save_interview_schedule_data';
$route['clear_interview'] = 'admin/Admin/clear_interview';
$route['ongoing_interview'] = 'admin/Admin/ongoing_interview';
$route['reject_interview'] = 'admin/Admin/reject_interview';
$route['update_job_schedule_data'] = 'admin/Admin/update_job_schedule_data';
$route['mail_interview_data'] = 'admin/Admin/mail_interview_data';
...
$route['intern-tast-report'] = 'admin/Admin/intern_tast_report';
$route['intern-self-task-daily-report'] = 'admin/Admin/intern_self_task_daily_report';
$route['intern-transfer-report'] = 'admin/Admin/intern_transfer_report';
$route['intern-certificate-report'] = 'admin/Admin/intern_certificate_report';
...
$route['volunteer-assign-task'] = 'admin/Admin/volunteer_assign_task';
$route['intern-assign-task-report'] = 'admin/Admin/intern_assign_task_report';
$route['pre-registration-volunteer-report'] = 'admin/Admin/pre_registration_volunteer_report';
$route['post-registration-volunteer-report'] = 'admin/Admin/post_registration_volunteer_report';
$route['onboard-volunteer'] = 'admin/Admin/onboard_volunteer';
